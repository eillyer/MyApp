...
- (DatePickerView *)initWithCustomeHeight:(CGFloat)height
{
    ...
    if (self) {
        ...
        cannel.frame = CGRectMake(20, 2, 50, 40);
        [cannel setTitle:@"取消" forState:0];
        [cannel setTitleColor:[UIColor colorWithRed:35/255.0 green:169/255.0 blue:1 alpha:1] forState:0];
        cannel.tag = 1;
        ...
        confirm.frame = CGRectMake(SCREEN_WIDTH-70, 2, 50, 40);
        [confirm setTitle:@"确定" forState:0];
        [confirm setTitleColor:[UIColor colorWithRed:35/255.0 green:169/255.0 blue:1 alpha:1]  forState:0];
        confirm.tag = 2;
