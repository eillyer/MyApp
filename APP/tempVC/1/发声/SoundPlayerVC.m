...
//铃声名称官网 ：http://iphonedevwiki.net/index.php/AudioServices
...
- (IBAction)sound:(id)sender {
    ...
    SoundPlay *play1 = [[SoundPlay alloc] initSystemSoundWithName:kSoundName SoundType:@"caf"];
    [play1 play];
}
