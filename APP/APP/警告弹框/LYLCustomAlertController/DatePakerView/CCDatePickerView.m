...
#define kDistance 70
//每行高
#define kCellHeight = (ScreenWidth-kDistance)/6
//显示的宽
#define kDateViewWid = ([UIScreen mainScreen].bounds.size.width)-100
...
-(void)setupUI
{
    ...
    self.dateView=[[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth-kDistance,ScreenWidth-kDistance)];
    self.dateView.center = self.center;
...
//    self.dateView.layer.cornerRadius=8;
    ...
    self.chooseTimeLabel=[[UILabel alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth-kDistance,(ScreenWidth-kDistance)/6)];
    [self.chooseTimeLabel setCAColorStarColor:kColorStar endColor:kColorEnd Tdo:nil];

//    self.chooseTimeLabel.backgroundColor = [UIColor blueColor];
    self.chooseTimeLabel.text=@"请选择时间";
    self.chooseTimeLabel.textColor=[UIColor whiteColor];
    ...
    UIView * line21=[[UIView alloc] initWithFrame:CGRectMake(0, (ScreenWidth-kDistance)/6*3, self.dateView.size.width, 1)];
    line21.backgroundColor=RGBA(237, 237, 237, 1.0);
    [self.dateView addSubview:line21];
    
    UIView * line22=[[UIView alloc] initWithFrame:CGRectMake(0, (ScreenWidth-kDistance)/6*4, self.dateView.size.width, 1)];
    line22.backgroundColor=RGBA(237, 237, 237, 1.0);
    [self.dateView addSubview:line22];
//
...
//
    ...
    UIView *a = [[UIView alloc] initWithFrame:CGRectMake(0, (ScreenWidth-kDistance)/6*5, ScreenWidth-kDistance, (ScreenWidth-kDistance)/6)];
    a.backgroundColor = [UIColor whiteColor];
    [self.dateView addSubview:a];
    ...
    self.cancelButton.frame=CGRectMake(0, 0,(ScreenWidth-kDistance)/2, (ScreenWidth-kDistance)/6);
    ...
    [self.okButton setTintColor:[UIColor blackColor]];
    self.okButton.titleLabel.font=[UIFont systemFontOfSize:17];
    self.okButton.frame=CGRectMake((ScreenWidth-kDistance)/2, 0,(ScreenWidth-kDistance)/2, (ScreenWidth-kDistance)/6);
    [a addSubview:self.okButton];
    ...
    //分隔
    UIView * lineOK=[[UIView alloc] initWithFrame:CGRectMake((ScreenWidth-kDistance)/2, 0,1, (ScreenWidth-kDistance)/6)];
    lineOK.backgroundColor=RGBA(237, 237, 237, 1.0);
    [a addSubview:lineOK];
...
//    [self.dateView addSubview:self.datePicker];
    [self.dateView insertSubview:self.datePicker atIndex:0];
...
- (void)addLabelTextWithName:(NSArray *)nameArray{
    ...
    UIView *a = [[UIView alloc] initWithFrame:CGRectMake(0, (ScreenWidth-kDistance)/6, ScreenWidth-kDistance, (ScreenWidth-kDistance)/6+3)];
    a.backgroundColor = [UIColor whiteColor];
...
//    [@"asdfasf" ZhuanUTF8]
    ...
    for (int i = 0; i < nameArray.count; i ++) {
        UILabel *label=[[UILabel alloc] initWithFrame:CGRectMake(self.dateView.size.width*(i+1)/7+9*i, self.line1.bottom, W(40), (ScreenWidth-kDistance)/6)];
...
-(CGFloat)pickerView:(UIPickerView *)pickerView rowHeightForComponent:(NSInteger)component {
    return self.dateView.frame.size.height/6;
}
...
-(UIPickerView *)datePicker {
    if (!_datePicker) {
        _datePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(W(50)-10, (ScreenWidth-kDistance)/4, self.dateView.size.width-W(50), self.dateView.size.height/3*2)];
